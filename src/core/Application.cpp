...
namespace engine
{
    ...
    bool Application::initialize()
    {
        ...
        {
            // General panel
            m_ui->registerPanel("General", [this]()
            {
            ...
            // Lighting & Shadows
            m_ui->registerPanel("Lighting & Shadows", [this]()
            {
            ...
            m_ui->registerPanel("Post-process & Performance", [this]()
            {
            ...
            // Sky & IBL
            m_ui->registerPanel("Sky & IBL", [this]()
            {
            ...
            // Terrain
            m_ui->registerPanel("Terrain", [this]()
            {
            ...
            // Scripting (Lua)
            m_ui->registerPanel("Scripting (Lua)", [this]()
            {
            ...
            // Input Mapping
            m_ui->registerPanel("Input Mapping", [this]()
            {
            ...
            // Import & Animation
            m_ui->registerPanel("Import & Animation", [this]()
            {
    ...
    int Application::run()
    {
        ...
        while (m_window->isOpen())
        {
            ...
            {
                ImGui::Checkbox("General", &m_panelGeneral);
                ImGui::Checkbox("Lighting & Shadows", &m_panelLighting);
                ImGui::Checkbox("Post-process & Performance", &m_panelPost);
                ImGui::Checkbox("Sky & IBL", &m_panelSkyIbl);
                ImGui::Checkbox("Terrain", &m_panelTerrain);
                ImGui::Checkbox("Scripting (Lua)", &m_panelScripting);
                ImGui::Checkbox("Audio", &m_panelAudio);
